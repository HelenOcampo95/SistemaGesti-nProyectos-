			...
			<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
				...
				<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
					...
					<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
						<!--begin::Title-->
						<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Facultades</h1>
						<!--end::Title-->
						<!--begin::Breadcrumb-->
							<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
								<!--begin::Item-->
								<li class="breadcrumb-item text-muted">
									<a href="../../demo1/dist/index.html" class="text-muted text-hover-primary">Información de facultad</a>
								</li>
								<!--end::Item-->
							</ul>
						<!--end::Breadcrumb-->
					...
					<div class="card-header border-0 pt-6">
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1">
								...
								<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-300px ps-15" id="buscador_categorias" placeholder="Buscar facultad"/>
							</div>
						<!-- ./ Input buscador de materias primas -->
						</div>
                </div>
        ...
        <div class="modal-content" id="registrar_categoria_content">
            <form class="form" id="formulario_registrar_categoria">
                <div class="modal-header" id="header_registrar_categoria">
                    <h2 class="fw-bold">Crear facultad</h2>
                ...
                <div class="modal-footer flex-center">
                    <button type="button" id="btn_registrar_categoria" class="btn btn-success" @click.prevent="registrarCategoria">
                        <span class="indicator-label">Registrar facultad</span>
            ...
            <form class="form" id="formulario_asignar_docente">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="mb-5 fv-row">
                        ...
                        <select  class="form-select form-select-solid" data-placeholder="Seleccione una facultad" name="id_categoria" id="id_categoria" required></select>
                    </div>
                    <div class="mb-5 fv-row">
