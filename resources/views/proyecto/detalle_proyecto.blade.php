...
<div class="modal fade" id="modal_registrar_version" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<div class="modal-content" id="registrar_version">
			<form class="form" id="formulario_registrar_version">
				<!-- Encabezado modal materias primas -->
				<div class="modal-header" id="kt_modal_add_customer_header">
					<h2 class="fw-bold">Versión</h2>
					<div id="kt_modal_add_customer_close" class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal" aria-label="Close">
						<span class="svg-icon svg-icon-1">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="currentColor" />
				...
				<div class="modal-body py-10 px-lg-17">
					<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
						<div class="card p-5 mb-5">
							<div class="row g-3">
								<div class="col-md-4">
									<label class="fs-6 fw-semibold mb-2 required">Versión</label>
									<input v-model="nuevaVersion.versionPro" 
									:class="{'border-danger': excedidos.version}"
									:maxlength="limites.versionPro" 
								...
								<div class="col-md-8">
									...
									<input type="text"
										...
										v-model="nuevaVersion.arc_relacionados"
										:class="{ 'border-danger': excedidos.url}"
										:maxlength="limites.arc_relacionados"/>
									<div class="d-flex justify-content-between mt-2">
								...
								<div class="fv-row mb-7">
									<label class="fs-6 fw-semibold mb-2 required">Descripción de cambios</label>
									<textarea class="form-control form-control-solid form-control-sm" 
										type="text" 
										class="form-control form-control-solid" 
										v-model="nuevaVersion.descripcion_cambios"
										:class="{'border-danger': excedidos.descripcionVer}"
										:maxlength="limites.descripcion_cambios">
									</textarea>
									<div class="d-flex justify-content-between mt-2">
										<small v-if="excedidos.descripcionVer" class="text-danger">
											Límite máximo alcanzado
										</small>
									</div>
								</div>
						...
						<input type="hidden" name="id_proyecto_version" id="id_proyecto_version" value="{{$proyecto->id_proyecto}}">
					</div>
				</div>
				<div class="modal-footer flex-center">
					<button type="button" id="btn_registrar_version" class="btn btn-success" @click.prevent="registrarVersion">
						<span class="indicator-label">Registrar</span>
						<span class="indicator-progress">Por favor espere...
						<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
					</button>
